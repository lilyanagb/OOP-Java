...
public class SummaryStatistics {
    ...
    //f
    public void companyStatsWithStreamAverage() {
        double sum=companies.stream().mapToDouble(o->o.getRevenue()).sum();
    ...
    public double statsWithStreamAverage() {
        ...
        System.out.println("Stream Numbers average: " + average.getAsDouble());
    ...
    public double statsWithStreamMin() {
        ...
        System.out.println("Stream Numbers min: " + min.getAsDouble());
    ...
    public double statsWithStreamReduce() {
        ...
        System.out.println("Stream Numbers sum: " + sum.get());
        return sum.get();
    }
